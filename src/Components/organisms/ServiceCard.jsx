    ...
    return (
        <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 flex flex-col gap-y-6 items-center text-center transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl group w-full ">
            ...
            <div className="relative w-24 h-24 flex items-center justify-center mb-4">
                ...
                <div className="absolute inset-0 flex items-center justify-center z-0 text-orange-50">
                    <svg width="100%" height="100%" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full opacity-100 transition-transform duration-500">
                ...
                {/* Icon */}
                <div className="relative z-10 w-16 h-16 rounded-full bg-transparent backdrop-blur-sm flex items-center justify-center text-orange-400 shadow-sm transition-transform duration-500 group-hover:scale-110">
            ...
            <div className="flex flex-col gap-y-3 grow">
                <h3 className="text-xl md:text-2xl font-bold font-primary text-mg-blue transition-colors duration-300">
                    {title}
                </h3>
